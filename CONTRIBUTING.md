...
Welcome to the contributor guide of icl-sizing-web-app.
...
If you experience bugs or general issues with icl-sizing-web-app, please have a look
...
You can help improve the documentation of icl-sizing-web-app by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/icl-sizing-web-app.git
   cd icl-sizing-web-app
   ```
